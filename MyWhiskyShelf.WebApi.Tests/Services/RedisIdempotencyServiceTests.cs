...
public class RedisIdempotencyServiceTests
{
    ...
    public async Task When_AddToCache_Expect_DatabaseUpdated()
    {
        ...
        var cachedResponse =
            new CachedResponse(200, "content", "application/json", new Dictionary<string, string?[]>());
        ...
        await _service.AddToCacheAsync(idempotencyKey, 200, "content", "application/json",
