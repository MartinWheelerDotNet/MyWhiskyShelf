...
{
    public static DistilleryResponse ToResponse(this Distillery distillery) => new()
    {
        Id = distillery.Id,
    ...
    public static Distillery ToDomain(this DistilleryCreateRequest distilleryCreateRequest) => new()
    {
    ...
    public static Distillery ToDomain(this DistilleryUpdateRequest distilleryCreateRequest, Guid id) => new()
    {
        Id = id,
        Name = distilleryCreateRequest.Name,
        Location = distilleryCreateRequest.Location,
