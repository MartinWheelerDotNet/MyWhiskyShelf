...
{
    public static WhiskyBottleResponse ToResponse(this WhiskyBottle whiskyBottle) => new()
    {
        Id = whiskyBottle.Id,
    ...
    public static WhiskyBottle ToDomain(this WhiskyBottleCreateRequest whiskyBottleRequest) => new()
    {
    ...
    public static WhiskyBottle ToDomain(this WhiskyBottleUpdateRequest whiskyBottleRequest) => new()
    {
        Name = whiskyBottleRequest.Name,
        DistilleryName = whiskyBottleRequest.DistilleryName,
        DistilleryId = whiskyBottleRequest.DistilleryId,
