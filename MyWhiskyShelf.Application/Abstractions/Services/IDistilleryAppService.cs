...
public interface IDistilleryAppService
{
    ...
    Task<GetAllDistilleriesResult> GetAllAsync(int amount, string afterCursor, CancellationToken ct = default);
    Task<GetAllDistilleriesResult> GetAllAsync(DistilleryFilterOptions filterOptions, CancellationToken ct = default);
