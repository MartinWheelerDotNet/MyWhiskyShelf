...
public class DistilleryNameCacheServiceTests
{
    ...
    [Fact]
    public async Task
        When_SearchAsyncAndQueryStringMatchesStartOfDistilleryName_Expect_MatchingDistilleryDetailsReturned()
    {
        List<DistilleryNameDetails> expectedDistilleryDetails =
        [
            new(DistilleryEntityTestData.Aberargie.Name, DistilleryEntityTestData.Aberargie.Id),
    ...
    [Fact]
    public async Task When_SearchAsyncAndBothDistilleryNameContainsQueryString_Expect_DistilleryDetailsInNameOrder()
    {
        List<DistilleryNameDetails> expectedDistilleryDetails =
        [
            new(DistilleryEntityTestData.AbhainnDearg.Name, DistilleryEntityTestData.AbhainnDearg.Id),
    ...
    [Fact]
    public async Task
        When_SearchAsyncAndDistilleryContainsFuzzyQueryString_Expect_FuzzyMatchingDistilleryDetailsReturned()
    {
        List<DistilleryNameDetails> expectedDistilleryDetails =
        [
            new(DistilleryEntityTestData.Aberargie.Name, DistilleryEntityTestData.Aberargie.Id)
    ...
    [Fact]
    public async Task
        When_SearchAsyncAndTwoDistilleriesContainsFuzzyQueryString_Expect_FuzzyMatchedDistilleryDetailsReturned()
    {
        List<DistilleryNameDetails> expectedDistilleryDetails =
        [
            new(DistilleryEntityTestData.AbhainnDearg.Name, DistilleryEntityTestData.AbhainnDearg.Id),
    ...
    [Fact]
    public void When_AddThenRemove_Expect_DistilleryDetailsRemovedFromCache()
    {
        var distilleryNameCacheService = new DistilleryNameCacheService();
